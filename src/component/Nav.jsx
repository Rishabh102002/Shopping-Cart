        ...
        <div className="flex bg-white px-44 py-2 mb-4 justify-between items-center shadow-custom sticky top-0 z-10">
            ...
            <nav className="flex gap-10">
                <NavLink
                    ...
                    className={({ isActive }) =>
                        isActive
                            ? " text-slate-800 font-bold p-2"
                            : " text-slate-400 font-normal p-2"
                    }
                >
                    Home
                </NavLink>
                ...
                <div className="relative flex justify-center items-center w-[48px] h-[48px]">
                    {cartList.length < 1 ? (
                        ...
                        <>
                            ...
                            <div className="absolute -top-0.5 -right-1 flex h-6 w-6 rounded-full justify-center items-center bg-red-600 text-white text-[12px] font-bold">
                                {cartList.length}
                            </div>
                        </>
                    )}
